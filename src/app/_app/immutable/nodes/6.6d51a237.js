import{d as A}from"../chunks/environment.9aa685ef.js";import{S as D,i as U,s as E,k as d,a as _,q as Z,_ as L,l as p,h as l,c as z,m as b,r as M,n as y,D as h,b as k,J as j,U as Y}from"../chunks/index.618ef35a.js";const O=A,R=!0,de=Object.freeze(Object.defineProperty({__proto__:null,csr:O,prerender:R},Symbol.toStringTag,{value:"Module"}));function G(n){return n.replace(/_/g," ").replace(/^\w/,e=>e.toUpperCase())}function B(n){return n.replace(/_/g,"-").toLowerCase()}const H=`# Intro
...
`,ce={intro:H,getting_started:X,the_editor:Q,patterns:$,streams:W,mini_notation:N,mutations:V,the_canvas:ee,zen_quantum:oe,instruments:K,effects:ne,custom_samples:J,global_settings:se,midi:te,utilities:ae,data:re,clocks:ie,modes:le},C=Object.entries(ce).map(([n,e])=>({title:G(n),slug:B(n),markdown:e}));function F(n,e,r){const o=n.slice();return o[0]=e[r].slug,o[1]=e[r].title,o}function P(n){let e,r,o=n[1]+"",i;return{c(){e=d("a"),r=d("li"),i=Z(o),this.h()},l(c){e=p(c,"A",{href:!0,class:!0});var u=b(e);r=p(u,"LI",{});var v=b(r);i=M(v,o),v.forEach(l),u.forEach(l),this.h()},h(){y(e,"href","/learn/"+n[0]),y(e,"class","chapter svelte-1t4x29s")},m(c,u){k(c,e,u),h(e,r),h(r,i)},p:j,d(c){c&&l(e)}}}function he(n){let e,r,o,i,c,u,v,x,f,w=C,a=[];for(let t=0;t<w.length;t+=1)a[t]=P(F(n,w,t));return{c(){e=d("meta"),r=_(),o=d("section"),i=d("div"),c=d("h1"),u=Z("Learn"),v=_(),x=d("nav"),f=d("ul");for(let t=0;t<a.length;t+=1)a[t].c();this.h()},l(t){const m=L("svelte-1wicnyl",document.head);e=p(m,"META",{name:!0,content:!0}),m.forEach(l),r=z(t),o=p(t,"SECTION",{class:!0});var s=b(o);i=p(s,"DIV",{class:!0});var g=b(i);c=p(g,"H1",{});var T=b(c);u=M(T,"Learn"),T.forEach(l),v=z(g),x=p(g,"NAV",{});var I=b(x);f=p(I,"UL",{class:!0});var S=b(f);for(let q=0;q<a.length;q+=1)a[q].l(S);S.forEach(l),I.forEach(l),g.forEach(l),s.forEach(l),this.h()},h(){document.title="Zen | Learn",y(e,"name","description"),y(e,"content","Learn how to make music with Zen, a musical live coding language that runs in your browser."),y(f,"class","svelte-1t4x29s"),y(i,"class","content__inner svelte-1t4x29s"),y(o,"class","content svelte-1t4x29s")},m(t,m){h(document.head,e),k(t,r,m),k(t,o,m),h(o,i),h(i,c),h(c,u),h(i,v),h(i,x),h(x,f);for(let s=0;s<a.length;s+=1)a[s]&&a[s].m(f,null)},p(t,[m]){if(m&0){w=C;let s;for(s=0;s<w.length;s+=1){const g=F(t,w,s);a[s]?a[s].p(g,m):(a[s]=P(g),a[s].c(),a[s].m(f,null))}for(;s<a.length;s+=1)a[s].d(1);a.length=w.length}},i:j,o:j,d(t){l(e),t&&l(r),t&&l(o),Y(a,t)}}}class pe extends D{constructor(e){super(),U(this,e,null,he,E,{})}}export{pe as component,de as universal};
