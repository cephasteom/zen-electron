import{d as M}from"../chunks/environment.9aa685ef.js";import{S as U,i as D,s as E,k as d,a as z,q as Z,_ as L,l as p,h as l,c as I,m as b,r as A,n as y,D as c,b as k,J as j,U as R}from"../chunks/index.618ef35a.js";const Y=M,G=!0,me=Object.freeze(Object.defineProperty({__proto__:null,csr:Y,prerender:G},Symbol.toStringTag,{value:"Module"}));function O(n){return n.replace(/_/g," ").replace(/^\w/,e=>e.toUpperCase())}function W(n){return n.replace(/_/g,"-").toLowerCase()}const B=`# Intro
...
`,le={intro:B,getting_started:X,the_editor:Q,patterns:$,streams:H,mini_notation:N,mutations:V,the_canvas:ee,zen_quantum:oe,instruments:K,effects:ne,custom_samples:J,global_settings:se,midi:te,utilities:ae,data:re,clocks:ie},C=Object.entries(le).map(([n,e])=>({title:O(n),slug:W(n),markdown:e}));function F(n,e,r){const o=n.slice();return o[0]=e[r].slug,o[1]=e[r].title,o}function P(n){let e,r,o=n[1]+"",i;return{c(){e=d("a"),r=d("li"),i=Z(o),this.h()},l(h){e=p(h,"A",{href:!0,class:!0});var u=b(e);r=p(u,"LI",{});var w=b(r);i=A(w,o),w.forEach(l),u.forEach(l),this.h()},h(){y(e,"href","/learn/"+n[0]),y(e,"class","chapter svelte-19qt133")},m(h,u){k(h,e,u),c(e,r),c(r,i)},p:j,d(h){h&&l(e)}}}function he(n){let e,r,o,i,h,u,w,x,f,v=C,a=[];for(let t=0;t<v.length;t+=1)a[t]=P(F(n,v,t));return{c(){e=d("meta"),r=z(),o=d("section"),i=d("div"),h=d("h1"),u=Z("Learn"),w=z(),x=d("nav"),f=d("ul");for(let t=0;t<a.length;t+=1)a[t].c();this.h()},l(t){const m=L("svelte-1wicnyl",document.head);e=p(m,"META",{name:!0,content:!0}),m.forEach(l),r=I(t),o=p(t,"SECTION",{class:!0});var s=b(o);i=p(s,"DIV",{class:!0});var g=b(i);h=p(g,"H1",{});var T=b(h);u=A(T,"Learn"),T.forEach(l),w=I(g),x=p(g,"NAV",{});var _=b(x);f=p(_,"UL",{class:!0});var S=b(f);for(let q=0;q<a.length;q+=1)a[q].l(S);S.forEach(l),_.forEach(l),g.forEach(l),s.forEach(l),this.h()},h(){document.title="Zen | Learn",y(e,"name","description"),y(e,"content","Learn how to make music with Zen, a musical live coding language that runs in your browser."),y(f,"class","svelte-19qt133"),y(i,"class","content__inner svelte-19qt133"),y(o,"class","content svelte-19qt133")},m(t,m){c(document.head,e),k(t,r,m),k(t,o,m),c(o,i),c(i,h),c(h,u),c(i,w),c(i,x),c(x,f);for(let s=0;s<a.length;s+=1)a[s]&&a[s].m(f,null)},p(t,[m]){if(m&0){v=C;let s;for(s=0;s<v.length;s+=1){const g=F(t,v,s);a[s]?a[s].p(g,m):(a[s]=P(g),a[s].c(),a[s].m(f,null))}for(;s<a.length;s+=1)a[s].d(1);a.length=v.length}},i:j,o:j,d(t){l(e),t&&l(r),t&&l(o),R(a,t)}}}class de extends U{constructor(e){super(),D(this,e,null,he,E,{})}}export{de as component,me as universal};
