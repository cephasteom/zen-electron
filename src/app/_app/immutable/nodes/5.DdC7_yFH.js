import{d as v}from"../chunks/Dnt3WWCM.js";import{f as u,h as q,a as l}from"../chunks/DagXSqBC.js";import"../chunks/DWWXGa6_.js";import{$ as x,c as s,s as p,r as e,t as S,l as f}from"../chunks/e0Y00CSs.js";import{s as k}from"../chunks/D1eO-sKs.js";import{e as j,i as C,s as T}from"../chunks/BYkFvx8V.js";import{f as A,a as F}from"../chunks/DCw9aPOv.js";const z=v,I=!0,ue=Object.freeze(Object.defineProperty({__proto__:null,csr:z,prerender:I},Symbol.toStringTag,{value:"Module"})),M=`# Intro
...
`,J={intro:M,getting_started:Z,the_editor:P,patterns:_,streams:D,mini_notation:U,mutations:E,zen_quantum:G,instruments:R,effects:L,custom_samples:O,zmod:X,q5js:V,global_settings:B,midi:W,utilities:Y,data:Q,clocks:H,modes:N},$=Object.entries(J).map(([a,t])=>({title:F(a),slug:A(a),markdown:t}));var K=u('<meta name="description" content="Learn how to make music with Zen, a musical live coding language that runs in your browser."/>'),ee=u('<li class="svelte-yrycp"> <a class="chapter svelte-yrycp"> </a></li>'),te=u('<section class="content svelte-yrycp"><div class="content__inner svelte-yrycp"><h1>Learn</h1> <nav><ul class="svelte-yrycp"></ul></nav></div></section>');function ce(a){var t=te();q(o=>{var n=K();x.title="Zen | Learn",l(o,n)});var c=s(t),d=p(s(c),2),m=s(d);j(m,5,()=>$,C,(o,n,g)=>{let b=()=>f(n).slug,y=()=>f(n).title;var i=ee(),h=s(i);h.nodeValue=`${g+1}. `;var r=p(h),w=s(r,!0);e(r),e(i),S(()=>{T(r,"href","/learn/"+b()),k(w,y())}),l(o,i)}),e(m),e(d),e(c),e(t),l(a,t)}export{ce as component,ue as universal};
