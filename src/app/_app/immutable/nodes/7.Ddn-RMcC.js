import{d as w}from"../chunks/Dnt3WWCM.js";import{f as c,h as j,a as l}from"../chunks/DagXSqBC.js";import"../chunks/DWWXGa6_.js";import{$ as x,c as s,s as p,r as e,t as k,l as y}from"../chunks/e0Y00CSs.js";import{s as S}from"../chunks/D1eO-sKs.js";import{e as C,i as T,s as _}from"../chunks/BYkFvx8V.js";import{f as Z,a as q}from"../chunks/DCw9aPOv.js";const F=w,A=!0,se=Object.freeze(Object.defineProperty({__proto__:null,csr:F,prerender:A},Symbol.toStringTag,{value:"Module"})),E=`# Intro
...
\`\`\`
`,W={intro:E,javascript_basics:M,streams:P,patterns:I,instruments:Y,effects:H,mini_notation:R,mutations:B,project_1_beatslicer:z,project_2_sequencing:D,project_3_harmony:J,project_4_text_to_music:N},L=Object.entries(W).map(([a,t])=>({title:q(a),slug:Z(a),markdown:t}));var O=c('<meta name="description" content="A tutorial on how to use Zen, for total beginners."/>'),G=c('<li class="svelte-yrycp"> <a class="chapter svelte-yrycp"> </a></li>'),X=c('<section class="content svelte-yrycp"><div class="content__inner svelte-yrycp"><h1>Tutorial</h1> <nav><ul class="svelte-yrycp"></ul></nav></div></section>');function ae(a){var t=X();j(r=>{var n=O();x.title="Zen | Tutorial",l(r,n)});var m=s(t),u=p(s(m),2),h=s(u);C(h,5,()=>L,T,(r,n,v)=>{let f=()=>y(n).slug,b=()=>y(n).title;var o=G(),d=s(o);d.nodeValue=`${v+1}. `;var i=p(d),g=s(i,!0);e(i),e(o),k(()=>{_(i,"href","/tutorial/"+f()),S(g,b())}),l(r,o)}),e(h),e(u),e(m),e(t),l(a,t)}export{ae as component,se as universal};
