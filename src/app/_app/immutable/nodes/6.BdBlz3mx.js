import{d as b}from"../chunks/DutbReQ2.js";import{f as l,h as y,a as i}from"../chunks/Bne4RYp0.js";import"../chunks/qM-48Tw4.js";import{$ as w,w as a,y as v,x as s,t as x,g as d}from"../chunks/DBy2rVNF.js";import{s as q}from"../chunks/DercEx8N.js";import{e as k,i as j,s as T}from"../chunks/BvpwEHG2.js";const I=b,z=!0,oe=Object.freeze(Object.defineProperty({__proto__:null,csr:I,prerender:z},Symbol.toStringTag,{value:"Module"}));function S(e){return e.replace(/_/g," ").replace(/^\w/,t=>t.toUpperCase())}function C(e){return e.replace(/_/g,"-").toLowerCase()}const F=`# Intro
...
`,W={intro:F,getting_started:Z,the_editor:P,patterns:A,streams:M,mini_notation:_,mutations:D,the_canvas:R,zen_quantum:B,instruments:Y,effects:O,custom_samples:U,global_settings:G,midi:E,utilities:L,data:X,clocks:H,modes:Q},$=Object.entries(W).map(([e,t])=>({title:S(e),slug:C(e),markdown:t}));var N=l('<meta name="description" content="Learn how to make music with Zen, a musical live coding language that runs in your browser."/>'),J=l('<a class="chapter svelte-1t4x29s"><li> </li></a>'),V=l('<section class="content svelte-1t4x29s"><div class="content__inner svelte-1t4x29s"><h1>Learn</h1> <nav><ul class="svelte-1t4x29s"></ul></nav></div></section>');function re(e){var t=V();y(r=>{var n=N();w.title="Zen | Learn",i(r,n)});var h=a(t),c=v(a(h),2),u=a(c);k(u,5,()=>$,j,(r,n)=>{let p=()=>d(n).slug,f=()=>d(n).title;var o=J(),m=a(o),g=a(m,!0);s(m),s(o),x(()=>{T(o,"href","/learn/"+p()),q(g,f())}),i(r,o)}),s(u),s(c),s(h),s(t),i(e,t)}export{re as component,oe as universal};
